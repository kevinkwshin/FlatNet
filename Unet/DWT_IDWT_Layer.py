...
class DWT_2D_tiny(Module):
    """
    input:
        the 2D data to be decomposed -- (N, C, H, W)
    ...
    def __init__(self, wavename):
        ...
        param wavename:
            pywt.wavelist(); in the paper, 'chx.y' denotes 'biorx.y'.
        """
    ...
    def get_matrix(self):
        ...
        return:
            self.matrix_low = \mathcal{L}, self.matrix_high = \mathcal{H}
        """
    ...
    def forward(self, input):
        ...
        param:
            input: the 2D data to be decomposed
        
        return:
            the low-frequency component of the input 2D data
        """
...
class DWT_2D(Module):
    ...
    def forward(self, input):
        ...
        return:
            the low-frequency and high-frequency components of the input 2D data
        """
        assert len(input.size()) == 4
        self.input_height = input.size()[-2]
        self.input_width = input.size()[-1]
...
class IDWT_2D(Module):
    ...
    def forward(self, LL, LH, HL, HH):
        ...
        param: 
            LL: the low-frequency component
            LH: the high-frequency component, hfc_lh
            HL: the high-frequency component, hfc_hl
            HH: the high-frequency component, hfc_hh
