...
def get_waveunet():
    ...
    return WaveUNet(encoder_in_channels=en_in_channels, encoder_out_channels=en_out_channels, decoder_in_channels=de_in_channels, decoder_out_channels=de_out_channels)